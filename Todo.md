...
## 追加のやるべきこと（2026-04-05 MITライセンス追加）
- MITライセンス文面を `LICENSE` として追加する
- 必要に応じてフォーマットを確認する
- テストを実行してグリーンを確認してからコミットする

## やったこと（2026-04-05 MITライセンス追加）
- `LICENSE` ファイルを新規作成し、MITライセンス本文を追加
- `npm run format` を実行し、フォーマット方針（Biome）に沿って確認
- `npm test` を実行し、全テストがグリーンであることを確認

## 追加のやるべきこと（2026-04-05 README英語版追加）
- 日本語版 `README.md` をメイン表示のまま維持しつつ、英語版 README への導線を追加する
- 英語版 `README` を新規作成し、既存の日本語版と同等の内容を英語で読めるようにする
- Biome で Markdown を整形し、テストがグリーンであることを確認してからコミットする

## やったこと（2026-04-05 README英語版追加）
- 日本語版 `README.md` の先頭に英語版 `README.en.md` へのリンクを追加し、既定表示を日本語のまま維持した
- 英語版 `README.en.md` を新規作成し、概要、インストール、コマンド、テスト、i18n などの主要説明を英語化した
- `npm test` を実行し、全 22 テストの通過を確認した
